 ...
 */
extern void pthread_qsort(int *base, const size_t nel,
...
inline static void pthread_qsort_local(int *base, const size_t first,
                                       const size_t last,
...
inline static void pthread_qsort_split(int *base, const size_t first,
...
inline static void pthread_qsort_swap(int *base, const size_t elem1,
                                      const size_t elem2);
/*
    arguments:
        (1) pointer to data array [input/output]
